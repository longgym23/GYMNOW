  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      items: const <BottomNavigationBarItem>[
        ...
        BottomNavigationBarItem(icon: Icon(Icons.restaurant_menu), label: 'Dinh dưỡng'), // <-- THÊM VÀO ĐÂY
        BottomNavigationBarItem(icon: Icon(Icons.person), label: 'Hồ sơ'),
      ],
        currentIndex: _selectedIndex,
        backgroundColor: const Color(0xFF1B263B), // Màu nền của thanh nav
        selectedItemColor: Theme.of(context).colorScheme.primary, // Màu cam cho tab được chọn
